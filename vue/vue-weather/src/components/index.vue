  ...
  <div class="contaner">
    ...
    <div class="address">
      ...
      <div class="city-info">
        ...
        <dl>
          <dt>风力：{{mapData.windDirection}} | 风向: {{mapData.windPower}} | 空气湿度：{{mapData.humidity}}</dt>
        </dl>
      </div>
    </div>
    <div class="feature">
      ...
      AMap.plugin("AMap.CitySearch", function() {
        ...
        citySearch.getLocalCity(function(status, result) {
          if (status === "complete" && result.info === "OK") {
            ...
            console.log(result);
            _self.getCurrentCityDate(result.city, _self);
          }
        });
      });
    },
    getCurrentCityDate(cityName, _self) {
